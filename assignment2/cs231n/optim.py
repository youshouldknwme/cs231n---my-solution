...
Inputs:
  - w: A numpy array giving the current weights. 현재 weight
  - dw: A numpy array of the same shape as w giving the gradient of the
    loss with respect to w. 해당 weight에 대한 gradient
...
Returns:
  ...
  - config: The config dictionary to be passed to the next iteration of the
    update rule. 다음 iteration에 전달되어야 하는 것?
