...
def generic_forward(x, w, b, normalization=None, gamma=None, beta=None, bn_param=None, dropout_param= None): #안에서 batchnorm 할건지 말건지 판별!
...
def generic_backward(dout, cache, normalization=None):
